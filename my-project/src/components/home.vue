    ...
    export default {
        ...
        methods: {
            loadData() {
                ...
                axios.post('/testUser/userlist',qs.stringify(param)).then((result) => {
                    var _data = result.data;
                    console.log(result);
                    this.userInfoList = _data.data;
                });
            ...
            deleteUser(rowData) {
                ...
                this.$alert('是否删除这条记录', '信息删除', {
                    ...
                    callback: action => {
                        ...
                        axios.post("/testUser/delete", qs.stringify(params)).then((result) => {
                            console.info(result);
            ...
            addSubmit() {
                ...
                this.$refs.addFormData.validate((valid) => {
                    ...
                    if (valid) {
                        ...
                        axios.post("/testUser/submit", qs.stringify(param)).then((result) => {
                            if (result.data.success) {
                                this.$message({
                                    type: 'info',
                                    message: '添加成功',
